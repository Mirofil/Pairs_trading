...
#MINUTE
scenario5={"freq":"1T",'lag':1, 'txcost':0.003, 'training_delta':[0,0,1], 'cutoff':0.7, 'formation_delta':[0,0,2], 'start':starting_date, 'end':ending_date, 'jump':[0,0,1], 'methods':['dist'], 'dist_num':20, 'threshold':2, 'stoploss':100,'name':"scenario5"}
scenario6={"freq":"1T",'lag':1, 'txcost':0.000, 'training_delta':[0,0,1], 'cutoff':0.7, 'formation_delta':[0,0,2], 'start':starting_date, 'end':ending_date, 'jump':[0,0,1], 'methods':['dist'], 'dist_num':20, 'threshold':2, 'stoploss':100,'name':'scenario6'}
scenario5_coint={"freq":"1T",'lag':1, 'txcost':0.003, 'training_delta':[0,0,1], 'cutoff':0.7, 'formation_delta':[0,0,2], 'start':starting_date, 'end':ending_date, 'jump':[0,0,1], 'methods':['coint'], 'dist_num':20, 'threshold':2, 'stoploss':100,'name':"scenario5"}
scenario6_coint={"freq":"1T",'lag':1, 'txcost':0.000, 'training_delta':[0,0,1], 'cutoff':0.7, 'formation_delta':[0,0,2], 'start':starting_date, 'end':ending_date, 'jump':[0,0,1], 'methods':['coint'], 'dist_num':20, 'threshold':2, 'stoploss':100,'name':'scenario6'}